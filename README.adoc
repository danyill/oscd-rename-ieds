...
:uri-plugin: https://github.com/danyill/oscd-rename-ieds
:uri-ci-bundle: https://danyill.github.io/oscd-rename-ieds/oscd-rename-ieds.js
:uri-material-icons: https://fonts.google.com/icons
:uri-openscd-core-plugin-demo: https://danyill.github.io/oscd-rename-ieds/index.deploy.html
:source-highlighter: highlight.js

== What is this?

This plugin allows renaming IEDs within an SCL file.
...
For a local resource, begins without a forward slash, e.g. `plugins/oscd-rename-ieds/dist/oscd-rename-ieds.js`. 
...
<.> Whether a document must be loaded for this plugin to be available
<.> URL which can be a local or remote resource. 
For a local resource, begins with a forward slash, e.g. `plugins/oscd-rename-ieds/dist/oscd-rename-ieds.js`. 
